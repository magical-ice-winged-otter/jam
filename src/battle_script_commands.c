...
{
    [BOON_ITEMS_BASIC_JUNGLE] = { ITEM_POKE_BALL, ITEM_SITRUS_BERRY, ITEM_LEPPA_BERRY, ITEM_ENERGY_POWDER, ITEM_HEAL_POWDER, ITEM_TINY_MUSHROOM, 0 },
...
static struct BoonPokemonInfo sBoonPokemonInfo[NUM_SPECIES] =
{
    ...
    [SPECIES_YANMA] = { ITEM_POKE_BALL, BOON_ITEMS_BASIC_JUNGLE },
    [SPECIES_LIEPARD] = { ITEM_POKE_BALL, BOON_ITEMS_BASIC_JUNGLE },
