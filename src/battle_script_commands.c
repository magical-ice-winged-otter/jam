...
enum BoonItems
{
    ...
    BOON_ITEMS_GREAT,
    BOON_ITEMS_ULTRA,
    BOON_ITEMS_UNDERWATER,
    BOON_ITEMS_LEGENDARY,
    BOON_ITEMS_WALKING_WAKE,
    BOON_ITEMS_COUNT
};
...
{
    [BOON_ITEMS_JUNGLE] = { ITEM_POKE_BALL, ITEM_SITRUS_BERRY, ITEM_LEPPA_BERRY, ITEM_ENERGY_POWDER, ITEM_HEAL_POWDER, ITEM_TINY_MUSHROOM, 0 },
    
    [BOON_ITEMS_UNDERWATER] = {ITEM_ULTRA_BALL, ITEM_PEARL, ITEM_LEPPA_BERRY, ITEM_SITRUS_BERRY, ITEM_REVIVAL_HERB, ITEM_ENERGY_ROOT, ITEM_LUM_BERRY, ITEM_PEARL_STRING, 0},

    [BOON_ITEMS_LEGENDARY] = { ITEM_MASTER_BALL, 0 },
    [BOON_ITEMS_WALKING_WAKE] = { ITEM_BLUE_FLUTE, 0 },
};
...
static struct BoonPokemonInfo sBoonPokemonInfo[NUM_SPECIES] =
{
    ...
    [SPECIES_YANMA] = { ITEM_POKE_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_TANGELA] = { ITEM_POKE_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_TOGEDEMARU] = { ITEM_POKE_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_SHIELDON] = { ITEM_POKE_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_COMFEY] = { ITEM_POKE_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_LIEPARD] = { ITEM_GREAT_BALL, BOON_ITEMS_JUNGLE },
    [SPECIES_LINOONE] = { ITEM_GREAT_BALL, BOON_ITEMS_JUNGLE },
    
    [SPECIES_RAPIDASH_GALAR] = { ITEM_GREAT_BALL, BOON_ITEMS_JUNGLE },
    
    [SPECIES_DHELMISE] = { ITEM_ULTRA_BALL, BOON_ITEMS_UNDERWATER },
    [SPECIES_SWAMPERT] = { ITEM_ULTRA_BALL, BOON_ITEMS_UNDERWATER },
    [SPECIES_LANTURN] = { ITEM_GREAT_BALL, BOON_ITEMS_UNDERWATER },
    [SPECIES_OVERQWIL] = { ITEM_ULTRA_BALL, BOON_ITEMS_UNDERWATER },

    [SPECIES_GYARADOS_MEGA] = { ITEM_ULTRA_BALL, BOON_ITEMS_LEGENDARY },
    [SPECIES_WALKING_WAKE] = { ITEM_MASTER_BALL, BOON_ITEMS_WALKING_WAKE }
};
