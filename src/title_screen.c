...
static const u32 sTitleScreenRayquazaGfx[] = INCBIN_U32("graphics/title_screen/mythicislandtiles.4bpp.smol");
static const u32 sTitleScreenRayquazaTilemap[] = INCBIN_U32("graphics/title_screen/mythicislandtiles.bin.smolTM");
